...
//
// MANUAL FIX (2026-08-26): dwEntityList / dwGameEntitySystem corrected from
// 0x652EAA0 -> 0x652EA90. The dumper's pattern resolution landed +0x10 past
// the real g_pGameEntitySystem global (verified by static signature scan of
// client.dll and a live entity-list walk). If you re-dump and the ESP again
// reports "dwEntityList -> read 0x0", re-apply -0x10 to both values.
...
namespace dota2_dumper {
    namespace offsets {
        ...
        namespace client_dll {
            constexpr std::ptrdiff_t dwEntityList = 0x652EA90;
            constexpr std::ptrdiff_t dwGameEntitySystem = 0x652EA90;
            constexpr std::ptrdiff_t dwGameEntitySystem_highestEntityIndex = 0x2090;
            constexpr std::ptrdiff_t dwGameRules = 0x61AD6E0;
